...
Welcome to ``layml`` contributor's guide.
...
If you experience bugs or general issues with ``layml``, please have a look
...
You can help improve ``layml`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``layml`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``layml``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n layml python=3 six virtualenv pytest pytest-cov
    conda activate layml
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/layml.git
    cd layml
...
#. Install |pre-commit|_::
   ...
   ``layml`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/layml
.. _issue tracker: https://github.com/<USERNAME>/layml/issues
.. <-- end -->
